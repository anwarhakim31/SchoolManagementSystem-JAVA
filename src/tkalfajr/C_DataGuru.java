 ...
 * @author Lenovo
 */
public class C_DataGuru extends javax.swing.JFrame {
    int xx, xy ;
    Connection conn = new Koneksi().connect();
    
     Object[] row = {"NIP", "Nama", "Tanggal Lahir", "Agama", "Hp", "Alamat", "Jenis Kelamin"};
    DefaultTableModel tabmode = new DefaultTableModel(null, row);
    
   
    // to show data table
    protected void DataParaGuru() {
        refresh();
        jtabelguru.setModel(tabmode);
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String g = rs.getString("Jenis_Kelamin");
    ...
    protected void simpan() {
        String query = "insert into tb_guru (NIP,Nama,Tanggal_Lahir,Agama,Hp,Alamat,Jenis_Kelamin) values (?,?,?,?,?,?,?)";
        try {
            ...
            pst.setString(5,thp.getText());
            pst.setString(6,talamat.getText());
            if (tlaki.isSelected()){
                pst.setString(7,tlaki.getText());
            }
            else if (tperempuan.isSelected()){
                pst.setString(7,tperempuan.getText());
            }
    ...
    protected void edit() {
        try {
            String query = "update tb_guru set Nip=?, Nama=?, Tanggal_Lahir=?,"
                    + " Agama=?, Hp=?, Alamat=?, Jenis_Kelamin=? where Nip=?";
    ...
    protected void delete() {
        ...
        if (choice == 0) {
            try {
                String query = "delete from tb_guru where Nip=" + tnip.getText();
    ...
    protected void tekantabel() {
        try {
            int row = jtabelguru.getSelectedRow();
            tnip.setText((String) jtabelguru.getModel().getValueAt(row, 0));
            tnama.setText((String) jtabelguru.getModel().getValueAt(row, 1));
            ttgl.setText((String) jtabelguru.getModel().getValueAt(row, 2));
            tagama.setText((String) jtabelguru.getModel().getValueAt(row, 3));
            thp.setText((String) jtabelguru.getModel().getValueAt(row, 4));
            talamat.setText((String) jtabelguru.getModel().getValueAt(row, 5));
            if (jtabelguru.getModel().getValueAt(row, 6).equals("Laki-Laki")){
    ...
    private void initComponents() {
        ...
        jtabelguru = new javax.swing.JTable();
        ...
        btkeluar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_export_19px.png"))); // NOI18N
        ...
        jLabel4.setText("FORM DATA GURU");
        ...
        tperempuan.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        tlaki.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jLabel18.setText("Hp/Telp");

        thp.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 255)));
        ...
        jtabelguru.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jtabelguru.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtabelguruMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jtabelguru);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(tnip, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(thp, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(22, 22, 22)))
                .addContainerGap())
        );
    ...
    private void jtabelguruMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtabelguruMouseClicked
        tekantabel();
    }//GEN-LAST:event_jtabelguruMouseClicked
    ...
    private void btcetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btcetakActionPerformed
        try {
         JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream("C_DataGuru.jasper"), null, Koneksi.connect());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(C_DataGuru.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable jtabelguru;
